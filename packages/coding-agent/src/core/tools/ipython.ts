...
try:
    import nest_asyncio as _pi_rlm_nest_asyncio
    _pi_rlm_nest_asyncio.apply()
except Exception:
    pass

try:
    import rlm as _pi_rlm_rlm_module
    rlm = _pi_rlm_rlm_module.rlm
except Exception as _pi_rlm_rlm_error:
    _PI_RLM_IMPORT_ERROR = str(_pi_rlm_rlm_error)

    class _PiRlmMissingRlm:
